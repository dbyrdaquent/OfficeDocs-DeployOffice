...
- Ent_Office_VL
- seo-marvel-apr2020
description: Understand Key Management Service (KMS), Multiple Activation Key (MAK), and Active Directory based activation methods for volume licensed versions of Office.
---
